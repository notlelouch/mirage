...
contract CryptoDevs is ERC721Enumerable, Ownable {
    ...
    function mint() public payable {
        ...
        // Here we are make sure that we always leave room for whitelisted reservations
        require(totalSupply() + reservedTokens - reservedTokensClaimed < maxTokenIds, "Exceeded max token supply");
    ...
    function withrdraw() public payable {
